...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'dulanthaoshada67@gmail.com', // Your Mega A/c Email Here
            password: 'himashimycush15##' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? '𝙳𝚄𝙻𝙰𝙽𝚃𝙷𝙰-𝙼𝙳=' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
                    ...
                    const MALVIN_TEXT = ` DONT SHARE THIS CODE WITH OTHER🫩👍`;
